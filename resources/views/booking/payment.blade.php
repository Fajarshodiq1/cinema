    ...
    <section id="Content" class="w-full max-w-[1280px] mx-auto px-5 lg:px-[52px] mt-16 mb-[100px]">
        <div class="flex flex-col gap-16">
            <div class="flex flex-col items-center gap-1">
                <p class="font-bold text-[32px] leading-[48px] capitalize text-black">Booking Film</p>
                <div class="flex items-center gap-2 text-black">
                    <a class="last:font-semibold text-xs lg:text-base">Homepage</a>
                    <span>></span>
                    <a class="last:font-semibold text-xs lg:text-base">Film Details</a>
                    <span>></span>
                    <a class="last:font-semibold text-xs lg:text-base">Booking Film</a>
                    <span>></span>
                    <a class="last:font-semibold text-xs lg:text-base">Confirmation Payment</a>
                </div>
            </div>
            <main class="flex flex-col lg:flex-row gap-8">
                ...
                <form id="Form" method="POST" enctype="multipart/form-data"
                    action="{{ route('front.payment_store') }}" class="flex flex-col w-full lg:w-[724px] gap-8">
                    @csrf
                                ...
                                <div class="flex flex-col py-5 px-8 gap-8">
                                    <div class="flex items-center justify-between gap-8">
                                        ...
                                        <div class="flex flex-col gap-[2px] w-full">
                                            <p class="font-medium text-aktiv-grey">BCA Cinemagundar Bank</p>
                                    ...
                                    <div class="flex items-center justify-between gap-8">
                                        ...
                                        <div class="flex flex-col gap-[2px] w-full">
                                            <p class="font-medium text-aktiv-grey">BNI Cinemagundar Bank</p>
                                    ...
                                    <div class="flex items-center justify-between gap-8">
                                        ...
                                        <div class="flex flex-col gap-[2px] w-full">
                                            <p class="font-medium text-aktiv-grey">BRI Cinemagundar Bank</p>
