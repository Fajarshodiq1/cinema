<nav class="fixed top-0 flex items-center w-full justify-between p-6 bg-white z-30">
    ...
    <a href={{ route('front.index') }}>
        <h1 class="text-2xl font-bold text-green-900">CINEMAGUNDAR</h1>
    </a>
    <!-- Navigation Links -->
    <ul id="menu"
        class="hidden lg:flex flex-col lg:flex-row lg:items-center lg:justify-center gap-16 w-full lg:w-auto bg-white lg:bg-transparent lg:p-0 p-4 absolute lg:static top-16 left-0 shadow-lg lg:shadow-none">
        <li
        ...
        <li
            class="font-medium text-aktiv-grey hover:font-semibold hover:text-aktiv-orange transition-all duration-300 mobile-item-spacing text-center">
            <a href="{{ route('front.film') }}">Films</a>
        </li>
        <li
            class="font-medium text-aktiv-grey hover:font-semibold hover:text-aktiv-orange transition-all duration-300 mobile-item-spacing text-center">
    ...
    <!-- Contact Button -->
    <a href="/admin" class="flex items-center rounded-full h-12 px-6 gap-[10px] bg-yellow-700">
        <span class="font-semibold text-sm md:text-base text-white">Login</span>
    </a>
</nav>
{{-- nav mobile phone --}}
<nav id="bottom-navigation" class="block lg:hidden fixed inset-x-0 bottom-0 bg-white shadow z-[99999]">
    <div id="tabs" class="flex justify-between">
        ...
        <a href="#"
            ...
            <span class="tab tab-explore block text-xs">My Booking</span>
        </a>
        <a href="#"
            class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
            <svg width="25" height="25" viewBox="0 0 42 42" class="inline-block mb-1">
            ...
            <span class="tab tab-whishlist block text-xs">Workshops</span>
        </a>
    </div>
</nav>
